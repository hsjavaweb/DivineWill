...
<body>
	...
	<s:iterator value="#list" var="topic" >
	        ...
	        <tr class="data">
	            ...
	            <a href="<s:url action='find'><s:param name='tid' value='tid' /></s:url>"><s:property  value="title" /></a>
	            </td>
	...
	<!--发表主题表单-->
	<s:form action="TopicAction_add" namespace="/" theme="simple" enctype="multipart/form-data">
	    ...
	    <table class="publishArticleForm">
	        ...
	        <tr>
	        	<td>附   图:</td>
	       		<td><s:file name="photo" label="照片" /></td>
	        </tr>
	        <tr>
	            <td></td>
